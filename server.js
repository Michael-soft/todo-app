...
const connectDB = require('./todo-app/config/database');
const authRoutes = require('./todo-app/routes/auth');
const taskRoutes = require('./todo-app/routes/task');
const indexRoutes = require('./todo-app/routes/index');
const Task = require('./todo-app/models/Task'); // Import the Task model
